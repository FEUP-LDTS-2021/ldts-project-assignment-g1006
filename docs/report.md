...
In our opinion, each individual of the group worked and contributed a lot to this project. While everyone focused on developing and testing new features, on a later stage each individual focused more on specific parts of it. For instance:
- Alexandre Correia did the UML diagram, implemented MVC, State and Command patterns, Menus and Buttons;
- Henrique Silva focused on probability functions, bug fixing, as well as Alien movement;
